...
//// }
//// sb.append("captain_id, vice_captain_id, updt_dtm VALUES
// (?,?,?,?,?,CURRENT_TIMESTAMP)");
////// Connection conn = null;
//// // conn = dataSource.getConnection();
////// PreparedStatement ps = conn.prepareStatement();
//// jdbcTemplateObject.update(sb.toString(), selection.getTeamId(),
// selectionGameweek,
//// selection.getSquad().get(SquadListing.PLAYER1),
//// selection.getSquad().get(SquadListing.PLAYER2),
// selection.getSquad().get(SquadListing.PLAYER3));
